...
namespace IIS.Tdva
{
    ...
    public class ИнфБронь : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Tdva.Пассажир fПассажир;
        
        private IIS.Tdva.Рейс fРейс;
        ...
        [PropertyStorage(new string[] {
                "Пассажир"})]
        [NotNull()]
        public virtual IIS.Tdva.Пассажир Пассажир
        {
            get
            {
                ...
                IIS.Tdva.Пассажир result = this.fПассажир;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Tdva.Рейс.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "Рейс"})]
        public virtual IIS.Tdva.Рейс Рейс
        {
            get
            {
                ...
                IIS.Tdva.Рейс result = this.fРейс;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ИнфБроньE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ИнфБроньE", typeof(IIS.Tdva.ИнфБронь));
                }
            }
        }
    }
    ...
    public class DetailArrayOfИнфБронь : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Tdva.DetailArrayOfИнфБронь members)

        // *** End programmer edit section *** (IIS.Tdva.DetailArrayOfИнфБронь members)
        ...
        /// </summary>
        public DetailArrayOfИнфБронь(IIS.Tdva.Рейс fРейс) : 
                base(typeof(ИнфБронь), ((ICSSoft.STORMNET.DataObject)(fРейс)))
        {
        }
        
        public IIS.Tdva.ИнфБронь this[int index]
        {
            get
            {
                return ((IIS.Tdva.ИнфБронь)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Tdva.ИнфБронь dataobject)
        {
